...
var db = mongojs("mongodb://localhost:27017/myRandomDB")
...
app.get('/loginsubmit',function(req,res){
	...
	db.sample1.find(prodata, function(err,dat){
		if(dat.length>0){
			...
			console.log('profile does not exist or password incorrect!!')
			res.send('profile does not exist or password incorrect!!')
		}
	})
})
